/*
file tinymce@5.0.7/plugins/powerpaste/plugin.js
*/
! function (l) {
    "use strict";
    var n = function (t) {
    ...
    var h, b, x, T, E, w = function (n) {
        ...
        U = k("function"),
        B = k("number"),
        Y = void 0 === (E = Array.prototype.indexOf) ? function (t, e) {
            return K(t, e)
        } : function (t, e) {
            return E.call(t, e)
        },
        ...
        G = function (t, e) {
            for (var n = 0, r = t.length; n < r; n++) {
                var o = t[n];
                if (e(o, n, t)) return P.some(o)
            }
            return P.none()
        },
        z = function (t, e) {
            for (var n = 0, r = t.length; n < r; n++)
                if (e(t[n], n, t)) return P.some(n);
            return P.none()
        },
        K = function (t, e) {
            for (var n = 0, r = t.length; n < r; ++n)
        ...
        ot = (U(Array.from) && Array.from, Object.keys),
        it = function (t, e) {
        ...
        ft = function (a) {
            if (!F(a)) throw new Error("cases must be an array");
            ...
            return $(a, function (t, r) {
                ...
                u.push(o), n[o] = function () {
                    ...
                    for (var n = new Array(t), e = 0; e < n.length; e++) n[e] = arguments[e];
                    return {
                        fold: function () {
                        ...
                        match: function (t) {
                            var e = ot(t);
                            if (u.length !== e.length) throw new Error("Wrong number of arguments to match. Expected: " + u.join(",") + "\nActual: " + e.join(","));
                            if (!tt(u, function (t) {
                                    return W(e, t)
        ...
        dt = function (a) {
            return function () {
                ...
                for (var n = {}, r = 0; r < t.length; r++) {
                    var o = t[r];
                    for (var i in o) lt.call(o, i) && (n[i] = a(n[i], o[i]))
                }
                return n
            }
        },
        ...
        ht = void 0 !== l.window ? l.window : Function("return this;")(),
        yt = function (t, e) {
            return function (t, e) {
                for (var n = null != e ? e : ht, r = 0; r < t.length && null != n; ++r) n = n[t[r]];
                return n
            }(t.split("."), e)
        },
        bt = function (t, e) {
            return function (t, e) {
                for (var n, r, o = void 0 !== e ? e : ht, i = 0; i < t.length; ++i) n = o, r = t[i], void 0 !== n[r] && null !== n[r] || (n[r] = {}), o = n[r];
                return o
            }(t.split("."), e)
        },
        xt = {
            getOrDie: function (t, e) {
                var n = yt(t, e);
                if (null == n) throw t + " not available on this browser";
                return n
            }
        };
    ...
    function St(t, e) {
        return n = l.document.createElement("canvas"), r = t, o = e, n.width = r, n.height = o, n;
        var n, r, o
    }

    function Lt(t) {
        var e = St(t.width, t.height);
        return _t(e).drawImage(t, 0, 0), e
    }
    ...
    var Nt = window.Promise ? window.Promise : function () {
        var i = function (t) {
                ...
                this._state = null, this._value = null, this._deferreds = [], f(t, n(o, this), n(u, this))
            },
        ...
        function o(t) {
            try {
                ...
                if (t && ("object" == typeof t || "function" == typeof t)) {
                    var e = t.then;
                    if ("function" == typeof e) return void f(n(e, t), n(o, this), n(u, this))
                }
    ...
    function At(t, r, o) {
        return r = r || "image/png", l.HTMLCanvasElement.prototype.toBlob ? new Nt(function (e, n) {
            t.toBlob(function (t) {
                t ? e(t) : n()
            }, r, o)
        }) : Dt(t.toDataURL(r, o))
    ...
    function Pt(t) {
        return (u = t, new Nt(function (t, e) {
    ...
    function Ut(t) {
        return (e = t, n = e.src, 0 === n.indexOf("data:") ? Dt(n) : Ct(n)).then(function (t) {
            return Ft(t)
        });
        var e, n
    }
    var Bt, Yt, Wt = function (t, e) {
        ...
        xe = function (t, e) {
            return Ie(t, e) ? (n = t, r = e.length, n.substring(r)) : t;
            var n, r
        },
        Te = function (t, e) {
            return Se(t, e) ? (n = t, r = e.length, n.substring(0, n.length - r)) : t;
            var n, r
        },
        Ee = function (t, e) {
        ...
        we = function (n) {
            return (t = n, "" === t ? P.none() : P.some(t.substr(0, 1))).bind(function (e) {
                return (t = n, "" === t ? P.none() : P.some(t.substring(1))).map(function (t) {
        ...
        Ae = function (t) {
            var e, n, r, o, i, a, u, c, s, f, l, d = De.browsers(),
                m = De.oses(),
                p = he(d, t).fold(ce.unknown, ce.nu),
                g = ye(m, t).fold(ge.unknown, ge.nu);
            return {
                browser: p,
                os: g,
                deviceType: (n = p, r = t, o = (e = g).isiOS() && !0 === /ipad/i.test(r), i = e.isiOS() && !o, a = e.isAndroid() && 3 === e.version.major, u = e.isAndroid() && 4 === e.version.major, c = o || a || u && !0 === /mobile/i.test(r), s = e.isiOS() || e.isAndroid(), f = s && !c, l = n.isSafari() && e.isiOS() && !1 === /safari/i.test(r), {
                    isiPad: v(o),
                    isiPhone: v(i),
                    isTablet: v(c),
                    isPhone: v(f),
        ...
        Fe = (l.Node.ATTRIBUTE_NODE, l.Node.CDATA_SECTION_NODE, l.Node.COMMENT_NODE),
        je = l.Node.DOCUMENT_NODE,
        Ue = (l.Node.DOCUMENT_TYPE_NODE, l.Node.DOCUMENT_FRAGMENT_NODE, l.Node.ELEMENT_NODE),
        Be = l.Node.TEXT_NODE,
        Ye = (l.Node.PROCESSING_INSTRUCTION_NODE, l.Node.ENTITY_REFERENCE_NODE, l.Node.ENTITY_NODE, l.Node.NOTATION_NODE, function (t) {
        ...
        Ve = qe(Ue),
        Xe = qe(Be),
        Ge = (qe(je), function (t, e, n) {
            if (!(M(n) || j(n) || B(n))) throw l.console.error("Invalid call to Attr.set. Key ", e, ":: Value ", n, ":: Element ", t), new Error("Attribute value was not simple");
            t.setAttribute(e, n + "")
        }),
        ze = function (t, e, n) {
            Ge(t.dom(), e, n)
        ...
        ln = {
            fromHtml: function (t, e) {
                ...
                if (n.innerHTML = t, !n.hasChildNodes() || 1 < n.childNodes.length) throw l.console.error("HTML does not have a single root node", t), new Error("HTML must have a single root node");
        ...
        pn = {
            insert: function (t, e) {
                ...
                for (var u = r.createDocumentFragment(); t.firstChild && !a.isBlock(t.firstChild);) u.appendChild(t.firstChild);
                for (var c = r.createDocumentFragment(); t.lastChild && !a.isBlock(t.lastChild);) c.appendChild(t.lastChild);
                if (n.parentNode.insertBefore(u, n), a.insertAfter(c, n), t.firstChild) {
        ...
        In = function (o) {
            ...
            e = function () {
                return i = {}, a = 0, gn.each(o.attributes, function (t) {
                    var e, n = t.nodeName,
                        r = t.value;
                    (!1 !== (e = t).specified || "name" === e.nodeName && "" !== e.value) && null != r && (i[n] = r, a++)
                }), void 0 === i.style && o.style.cssText && (i.style = o.style.cssText, a++), e = u, i
            };
            ...
            return {
                ...
                filter: function (t) {
                    var n, r;
                    c || (s = e), r = t, c = (n = c) && r ? function (t, e) {
                        return r(t, n(t, e))
                    } : n || r, e = function () {
                        return e = s, f(function (t, e) {
                            var n = c(t, e);
                            null === n ? (o.removeAttribute(t), delete i[t], a--) : n !== e && ("class" === t ? o.className = n : o.setAttribute(t, n), i[t] = n)
                        }), e = u, i
                    }
                },
        ...
        _n = function (i, t, e) {
            ...
            switch (i.nodeType) {
            case 1:
                t ? n = Tn : (n = xn, a = In(i), u = {}, c = i, s = function (t, e) {
                    u[t] = e
                }, null != (d = e || c.getAttribute("style")) && d.split || (d = c.style.cssText), gn.each(d.split(";"), function (t) {
                    var e = t.indexOf(":");
                    0 < e && ((f = gn.trim(t.substring(0, e))).toUpperCase() === f && (f = f.toLowerCase()), f = f.replace(/([A-Z])/g, function (t, e) {
                        return "-" + e.toLowerCase()
                    }), l = gn.trim(t.substring(e + 1)), Ln || (Ln = 0 === f.indexOf("mso-")), s(f, l))
                }), Ln || (l = c.style["mso-list"]) && s("mso-list", l)), r = "HTML" !== i.scopeName && i.scopeName && i.tagName && i.tagName.indexOf(":") <= 0 ? (i.scopeName + ":" + i.tagName).toUpperCase() : i.tagName;
                break;
            case 3:
                n = En, o = i.nodeValue;
                break;
                ...
                filterStyles: function (r) {
                    if (m() === xn) {
                        ...
                        gn.each(u, function (t, e) {
                            var n = r(e, t);
                            null === n ? (i.style.removeProperty ? i.style.removeProperty(Sn(e)) : i.style.removeAttribute(Sn(e)), delete u[e]) : (o += e + ": " + n + "; ", u[e] = n)
                        }), o = o || null, p(function (t, e) {
                            return "style" === t ? o : e
                        }), i.style.cssText = o
                    }
                },
        ...
        An = function (t, o) {
            var i;
            o = o || window.document, i = o.createElement("div"), o.body.appendChild(i), i.style.position = "absolute", i.style.left = "-10000px", i.innerHTML = t;
            ...
            return {
                ...
                next: function () {
                    var t, e, n = a,
                        r = c;
                    return !c && a.firstChild ? (u.push(a), a = a.firstChild) : c || 1 !== a.nodeType ? a.nextSibling ? (a = a.nextSibling, c = !1) : (a = u.pop(), c = !0) : c = !0, n === On.FINISHED || a || (o.body.removeChild(i), a = On.FINISHED), e = r, (t = n) === On.FINISHED ? t : t ? On.token(t, e) : void 0
                }
            }
        },
        Pn = function (p, g) {
            return function (e, t, n) {
                var r, o, i, a = !1,
                    ...
                    m = {
                        ...
                        emit: s,
                        receive: function (t) {
                            g && o.push(t), p(m, t), t === On.FINISHED && f()
                        },
        ...
        Mn = function (n) {
            return Pn(function (t, e) {
                e.filterAttributes(gn.bind(n, t)), t.emit(e)
            })
        },
        Rn = /^(P|H[1-6]|T[DH]|LI|DIV|BLOCKQUOTE|PRE|ADDRESS|FIELDSET|DD|DT|CENTER)$/,
        Fn = function () {
            return null
        },
        jn = !1,
        Un = kn(function (t, e) {
            var n, r = function () {
                jn || (t.emit(On.createStartElement("P", {}, {}, t.document)), jn = !0)
            };
            switch (e.type()) {
            case On.TEXT_TYPE:
                r(), t.emit(e);
                break;
            case On.END_ELEMENT_TYPE:
                jn && (n = e, Rn.test(n.tag()) || e === On.FINISHED) ? (t.emit(On.createEndElement("P", t.document)), jn = !1) : "BR" === e.tag() && t.emit(e);
                break;
            case On.START_ELEMENT_TYPE:
                "BR" === e.tag() ? (e.filterAttributes(Fn), e.filterStyles(Fn), t.emit(e)) : "IMG" === e.tag() && e.getAttribute("alt") && (r(), t.emit(On.createText(e.getAttribute("alt"), t.document)))
            }
        ...
        Yn = [Bn],
        Wn = tinymce.isIE && 9 <= document.documentMode ? [function (t) {
        ...
        qn = /^(mso-.*|tab-stops|tab-interval|language|text-underline|text-effect|text-line-through|font-color|horiz-align|list-image-[0-9]+|separator-image|table-border-color-(dark|light)|vert-align|vnd\..*)$/,
        $n = kn(function (t, e) {
            var r, n = t.settings.get("retain_style_properties");
            e.filterStyles((r = n, function (t, e) {
                var n = !1;
                switch (r) {
                case "all":
                case "*":
        ...
        Vn = kn(function (t, e) {
            t.seenList || (t.inferring ? "LI" === e.tag() && (e.type() === On.START_ELEMENT_TYPE ? t.inferring++ : (t.inferring--, t.inferring || (t.needsClosing = !0))) : ("OL" === e.tag() || "UL" === e.tag() ? t.seenList = !0 : "LI" === e.tag() && (t.inferring = 1, t.needsClosing || t.emit(On.createStartElement("UL", {}, {}, t.document))), !t.needsClosing || t.inferring || e.isWhitespace() || (t.needsClosing = !1, t.emit(On.createEndElement("UL", t.document))))), t.emit(e)
        }),
        Xn = Mn(function (t, e) {
            return "name" === t || "id" === t ? null : e
        }),
        Gn = Mn(function (t, e) {
            if ("class" === t) switch (this.settings.get("strip_class_attributes")) {
            case "mso":
        ...
        rr = function (t, e) {
            ...
            for (n = e + 1; n < t; n++)
                if ((r = tr[n]) && "SPAN" === r.tag())
                    if (r.type() === On.START_ELEMENT_TYPE) o++;
                    else if (r.type() === On.END_ELEMENT_TYPE && 0 == --o) return void(tr[n] = null)
        },
        or = function (t, e) {
            if (tr.push(e), er = er || [], e.type() === On.START_ELEMENT_TYPE) er.push(e);
            else if (e.type() === On.END_ELEMENT_TYPE && (er.pop(), 0 === er.length)) return void
            function (t) {
                if (nr) {
                    var e = void 0,
                        n = tr.length,
                        r = void 0;
                    for (r = 0; r < n; r++)(e = tr[r]) && (e.type() === On.START_ELEMENT_TYPE && "SPAN" === e.tag() && Kn(e) ? rr(n, r) : t.emit(e))
                }
                tr = [], nr = !(er = [])
            }(t)
        },
        ir = kn(function (t, e) {
            ...
            0 === (tr = tr || []).length ? e.type() === On.START_ELEMENT_TYPE ? n(e) ? t.emit(e) : or(t, e) : t.emit(e) : (nr || (nr = n(e)), or(t, e))
        }),
        ar = Mn(function (t, e) {
        ...
        cr = kn(function (t, e) {
            if ("IMG" === e.tag()) {
                if (e.type() === On.END_ELEMENT_TYPE && t.skipEnd) return void(t.skipEnd = !1);
                if (e.type() === On.START_ELEMENT_TYPE) {
                    if (/^file:/.test(e.getAttribute("src"))) return void(t.skipEnd = !0);
                    if (t.settings.get("base_64_images") && /^data:image\/.*;base64/.test(e.getAttribute("src"))) return void(t.skipEnd = !0)
                }
            }
            t.emit(e)
        }),
        ...
        dr = kn(function (t, e) {
            var n;
            e.type() === On.START_ELEMENT_TYPE && "A" === e.tag() ? (lr.push(e), fr(e) && t.defer(e)) : e.type() === On.END_ELEMENT_TYPE && "A" === e.tag() ? (n = lr.pop(), fr(n) && t.defer(e), 0 === lr.length && t.emitDeferred()) : t.hasDeferred() ? t.defer(e) : t.emit(e)
        }),
        mr = !1,
        pr = [kn(function (t, e) {
        ...
        Sr = {
            guessListType: function (t, e, n) {
                var r, o, i, a = null;
                return t && (r = t.text, o = t.symbolFont), r = gn.trim(r), (a = Er[r]) ? a = wr(a, r) : o ? a = (a = Tr[r]) ? wr(a, r) : {
                    tag: "UL",
                    variant: r
                } : (gn.each(xr, function (t) {
                    if (t.regex.test(r)) {
                        if (e && Ir(t.type, e, !0)) return (a = t.type).start = parseInt(r, 10), !1;
                        a || (a = t.type), a.start = parseInt(r, 10)
                    }
                }), a && !a.variant && (i = "(" === r.charAt(0) ? "()" : ")" === r.charAt(r.length - 1) ? ")" : ".", a = wr(a, i))), a && "OL" === a.tag && n && ("P" !== n.tag() || /^MsoHeading/.test(n.getAttribute("class"))) && (a = null), a
            },
            eqListType: Ir,
        ...
        Lr = function (t) {
            var e = t.indexOf(".");
            if (0 <= e && void 0 === gn.trim(t.substring(e + 1))) return (void 0)[2], !1
        },
        _r = (Bt = function (t, e) {
            var n, r = /([^{]+){([^}]+)}/g;
            for (r.lastIndex = 0; null !== (n = r.exec(t));) gn.each(n[1].split(","), Lr(void 0));
            return !1
        }, Yt = {}, function (t, e) {
            var n, r = t + "," + e;
            return Yt.hasOwnProperty(r) ? Yt[r] : (n = Bt.call(null, t, e), Yt[r] = n)
        }),
        Nr = function (t, e) {
            var n, r, o, i = !1,
                a = function (t) {
            ...
            if (t.type() === On.START_ELEMENT_TYPE && e.openedTag && "SPAN" === t.tag()) {
                for (a(n = e.openedTag.getNode()), 1 < n.childNodes.length && "A" === n.firstChild.tagName && "" === n.firstChild.textContent && (n = n.childNodes[1]); n.firstChild && ("SPAN" === n.firstChild.tagName || "A" === n.firstChild.tagName);) a(n = n.firstChild);
                if (!(n = n.firstChild) || 3 !== n.nodeType) return n && "IMG" === n.tagName;
                if (r = n.value, gn.trim(r) || (r = (n = n.parentNode.nextSibling) ? n.value : ""), !n || gn.trim(n.parentNode.textContent) != r) return !1;
                if (o = Sr.guessListType({
                        text: r,
                        symbolFont: i
                    }, null, e.originalToken)) return n.nextSibling && "SPAN" === n.nextSibling.tagName && /^[\u00A0\s]/.test(n.nextSibling.firstChild.value) && ("P" === e.openedTag.tag() || "UL" === o.tag)
            }
            return !1
        },
        Cr = function () {
            ...
            return {
                guessIndentLevel: function (t, e, n, r) {
                    var o, i;
                    return r && /^([0-9]+\.)+[0-9]+\.?$/.test(r.text) ? r.text.replace(/([0-9]+|\.$)/g, "").length + 1 : (o = u || parseInt(_r(n, e.getAttribute("class"))), i = function (t, e) {
                        var n, r = 0;
                        for (n = t.parentNode; null != n && n !== e.parentNode;) r += n.offsetLeft, n = n.offsetParent;
                        return r
                    }(t.getNode(), e.getNode()), o ? a ? i += a : 0 === i && (i += a = o) : o = 48, u = o = Math.min(i, o), Math.max(1, Math.floor(i / o)) || 1)
                }
            }
        },
        Or = function () {
            ...
            return {
                check: function (t) {
                    return e && t.type() === On.TEXT_TYPE ? (t.text(), !0) : t.type() === On.START_ELEMENT_TYPE && "STYLE" === t.tag() ? e = !0 : t.type() === On.END_ELEMENT_TYPE && "STYLE" === t.tag() && !(e = !1)
                }
            }
        },
        ...
        var i, o = [],
            ...
            f = function (t, e) {
                ...
                s++, e && t.type && (n = {
                    ...
                    start: t.start
                }), o.push(t), a.emit(On.createStartElement(t.tag, r, n, u)), i = t
            },
            l = function () {
                a.emit(On.createEndElement(o.pop().tag, u)), s--, i = o[o.length - 1]
            },
            d = function () {
                var t = c ? c.pop() : "P";
                "P" !== t && a.emit(On.createEndElement(t, u)), a.emit(On.createEndElement("LI", u))
            },
            m = function (t, e, n) {
                var r = {};
                if (t) {
                ...
                i && !Sr.eqListType(i, e) && (l(), n && (a.emit(On.createStartElement("P", {}, {}, u)), a.emit(On.createText("\xa0", u)), a.emit(On.createEndElement("P", u))), f(e, !0)), a.emit(On.createStartElement("LI", {}, r, u)), t && "P" !== t.tag() ? (c.push(t.tag()), t.filterStyles(function () {
                    return null
                }), a.emit(t)) : c.push("P")
            };
        return {
            ...
            openItem: function (t, e, n, r) {
                if (n) {
                    for (s || (s = 0); t < s;) d(), l();
                    var o, i;
                    if (i = t, "UL" === (o = n).tag && Dr[i - 1] === o.type && (o = {
                            tag: "UL"
                        }), n = o, s === t) d(), m(e, n, r);
                    else
                        for (1 < t && 0 < c.length && "P" !== c[c.length - 1] && (a.emit(On.createEndElement(c[c.length - 1], u)), c[c.length - 1] = "P"); s < t;) f(n, s === t - 1), m(s === t ? e : void 0, n)
                }
            },
    ...
    var Pr = function (t, e) {
            gn.log("Unexpected token in list conversion: " + e.toString()), t.rollback()
        },
        kr = function (t, e, n) {
            n.type() === On.TEXT_TYPE && "" === gn.trim(n.text()) ? t.defer(n) : e.skippedPara || n.type() !== On.START_ELEMENT_TYPE || "P" !== n.tag() || Qn(n) ? Rr(t, e, n) : (e.openedTag = n, t.defer(n), e.nextFilter = Mr)
        },
        Mr = function (t, e, n) {
            n.type() !== On.START_ELEMENT_TYPE || "SPAN" !== n.tag() || 0 !== e.spanCount.length || !Zn && Nr(n, e) || Qn(n) ? n.type() === On.END_ELEMENT_TYPE ? "SPAN" === n.tag() ? (t.defer(n), e.spanCount.pop()) : "P" === n.tag() ? (t.defer(n), e.skippedPara = !0, e.openedTag = null, e.nextFilter = kr) : (e.nextFilter = Rr, e.nextFilter(t, e, n)) : n.isWhitespace() ? t.defer(n) : (e.nextFilter = Rr, e.nextFilter(t, e, n)) : (t.defer(n), e.spanCount.push(n))
        },
        Rr = function (t, e, n) {
            var r = function () {
                e.emitter.closeAllLists(), t.emitDeferred(), e.openedTag = null, t.emit(n), e.nextFilter = Rr
            };
            if (n.type() === On.START_ELEMENT_TYPE && Qn(n) && "LI" !== n.tag()) {
                var o = / level([0-9]+)/.exec(n.getStyle("mso-list"));
                o && o[1] ? (e.itemLevel = parseInt(o[1], 10) + e.styleLevelAdjust, e.nextFilter === Rr ? t.emitDeferred() : t.dropDeferred(), e.nextFilter = jr, t.startTransaction(), e.originalToken = n, e.commentMode = !1) : r()
            } else !Zn && (n.type() === On.COMMENT_TYPE && "[if !supportLists]" === n.text() || Nr(n, t)) ? (n.type() === On.START_ELEMENT_TYPE && "SPAN" === n.tag() && e.spanCount.push(n), e.nextFilter = jr, t.startTransaction(), e.originalToken = e.openedTag, e.commentMode = !0, e.openedTag = null, t.dropDeferred()) : n.type() === On.END_ELEMENT_TYPE && Jn(n) ? (t.defer(n), e.spanCount.pop()) : n.type() === On.START_ELEMENT_TYPE ? Jn(n) ? (t.defer(n), e.spanCount.push(n)) : (e.openedTag && (e.emitter.closeAllLists(), t.emitDeferred()), e.openedTag = n, t.defer(n)) : r()
        },
        Fr = function (t, e, n) {
            n.type() === On.END_ELEMENT_TYPE && e.originalToken.tag() === n.tag() && (e.nextFilter = kr, e.styleLevelAdjust = -1), t.emit(n)
        },
        jr = function (t, e, n) {
            if (n.type() === On.START_ELEMENT_TYPE && "Ignore" === n.getStyle("mso-list") && (e.nextFilter = Ur), n.type() === On.START_ELEMENT_TYPE && "SPAN" === n.tag()) e.spanCount.push(n), (e.commentMode && "" === n.getAttribute("style") || null === n.getAttribute("style")) && (e.nextFilter = Ur);
            else if ("A" === n.tag()) n.type() === On.START_ELEMENT_TYPE ? e.spanCount.push(n) : e.spanCount.pop();
            else if (n.type() === On.TEXT_TYPE)
                if (e.commentMode) e.nextFilter = Ur, e.nextFilter(t, e, n);
                else {
                    var r = e.originalToken,
                        o = e.spanCount;
                    e.emitter.closeAllLists(), t.emit(r), gn.each(o, gn.bind(t.emit, t)), t.emit(n), t.commit(), e.originalToken = r, e.nextFilter = Fr
                }
            else(e.commentMode || n.type() !== On.COMMENT_TYPE) && Pr(t, n)
        },
        Ur = function (t, e, n) {
            n.type() === On.TEXT_TYPE ? n.isWhitespace() || (e.nextFilter = Br, e.bulletInfo = {
                text: n.text(),
                symbolFont: e.symbolFont
            }) : Jn(n) ? n.type() === On.START_ELEMENT_TYPE ? e.spanCount.push(n) : e.spanCount.pop() : n.type() === On.START_ELEMENT_TYPE && "IMG" === n.tag() ? (e.nextFilter = Br, e.bulletInfo = {
                text: "\u2202",
                symbolFont: !0
            }) : Pr(t, n)
        },
        Br = function (t, e, n) {
            n.type() === On.START_ELEMENT_TYPE && Jn(n) ? (e.spanCount.push(n), e.nextFilter = Yr) : n.type() === On.END_ELEMENT_TYPE && Jn(n) ? (e.spanCount.pop(), e.nextFilter = Wr) : n.type() === On.END_ELEMENT_TYPE && "IMG" === n.tag() || Pr(t, n)
        },
        Yr = function (t, e, n) {
            n.type() === On.END_ELEMENT_TYPE && (Jn(n) && e.spanCount.pop(), e.nextFilter = Wr)
        },
        Wr = function (o, i, a) {
            var t = function (t) {
                var e, n, r;
                if (i.nextFilter = Hr, i.commentMode && (i.itemLevel = i.indentGuesser.guessIndentLevel(a, i.originalToken, i.styles.styles, i.bulletInfo)), i.listType = Sr.guessListType(i.bulletInfo, (e = i.emitter.getCurrentListType(), n = i.emitter.getCurrentLevel(), r = i.itemLevel, n === r ? e : null), i.originalToken), i.listType) {
                    ...
                    t && o.emit(a)
                } else gn.log("Unknown list type: " + i.bulletInfo.text + " Symbol font? " + i.bulletInfo.symbolFont), o.rollback()
            };
        ...
        Hr = function (t, e, n) {
            n.type() === On.END_ELEMENT_TYPE && n.tag() === e.originalToken.tag() ? (e.nextFilter = kr, e.skippedPara = !1) : t.emit(n)
        },
        qr = {
            initial: Rr
        },
        $r = {},
        Vr = function (t) {
            $r.nextFilter = qr.initial, $r.itemLevel = 0, $r.originalToken = null, $r.commentMode = !1, $r.openedTag = null, $r.symbolFont = !1, $r.listType = null, $r.indentGuesser = Cr(), $r.emitter = Ar(t, t.document), $r.styles = Or(), $r.spanCount = [], $r.skippedPara = !1, $r.styleLevelAdjust = 0, $r.bulletInfo = void 0
        };
    Vr({});
    var Xr = [hr, kn(function (t, e) {
            $r.styles.check(e) || ($r.symbolFont = Sr.checkFont(e, $r.symbolFont), $r.nextFilter(t, $r, e))
        }, function (t) {
            Vr(t)
        }), yr, br, vr, gr],
        Gr = function (t, e, n, r) {
            for (var o = Dn(n), i = An(t, n), a = function (t, e, n, r) {
                    ...
                    return i
                }(r, o, e, n); i.hasNext();) a.receive(i.next());
            return o.dom
        },
        zr = function (t) {
        ...
        Kr = {
            filter: function (t, e, n) {
                ...
                e.setWordContent(o);
                var i = pr;
                return o && (i = Xr.concat(pr)), Gr(r, e, n, i)
            },
        ...
        Jr = {
            openDialog: function (t, e, n) {
                var r, o = e("cement.dialog.paste.clean"),
                ...
                r = t.windowManager.open(u), setTimeout(function () {
                    r && r.getEl().focus()
                }, 1)
            }
        },
    ...
    function to(a, u, c) {
        return {
            showDialog: function (o) {
                var t, e = a.settings.powerpaste_word_import || Zr.officeStyles,
                    n = a.settings.powerpaste_html_import || Zr.htmlStyles,
                    r = Kr.isWordContent(o) ? e : n,
                    i = function (t) {
                        var e = {
                            content: o
                        };
    ...
    function eo(u, t, e, r, c) {
            ...
            m = function (t) {
                sn.multiple(t).get(function (t) {
                    var e = q(t, function (t) {
                        ...
                        return ze(e, "src", n), e.dom().outerHTML
                    }).join("");
                    u.insertContent(e, {
        ...
        u.on("drop", function (t) {
            if (!s) {
                ...
                var n = (a = (i = t).target.files || i.dataTransfer.files, V(a, function (t) {
                ...
                d(o = r) || !l(o, "text/html") && !l(o, "text/plain") || (to(u, mn.translate, c).showDialog(r["text/html"] || r["text/plain"]), t.preventDefault())
            }
            var o, i, a
        })
    }
    var no = function () {
            ...
            return function () {
                ...
                if (e.length !== n.length) throw new Error('Wrong number of arguments to struct. Expected "[' + e.length + ']", got ' + n.length + " arguments");
                var r = {};
        ...
        oo = function (e, t) {
            if (!F(t)) throw new Error("The " + e + " fields must be an array. Was: " + t + ".");
            $(t, function (t) {
                if (!M(t)) throw new Error("The value " + t + " in the " + e + " fields was not a string.")
            })
        },
        io = function (o, i) {
            var n, a = o.concat(i);
            if (0 === a.length) throw new Error("You must specify at least one required or optional field.");
            return oo("required", o), oo("optional", i), n = ro(a), G(n, function (t, e) {
    ...
    function co(t) {
        ...
        return {
            bind: function (t) {
                if (void 0 === t) throw "Event bind error: undefined handler";
                r.push(t)
            },
            unbind: function (e) {
                r = V(r, function (t) {
    ...
    var so = {
        ...
        Bo = (no("element", "offset"), function (t, e) {
            var n = [];
            return $(Mo(t), function (t) {
                e(t) && (n = n.concat([t])), n = n.concat(Bo(t, e))
            }), n
        }),
        Yo = function (t, e) {
            return So(e, t)
    ...
    function $o() {
        ...
        return {
            ...
            report: function (t, e, r) {
                ...
                $(e, function (t) {
                    var e, n;
                    Qe(t, Wo), e = r, n = t, i.push({
                        success: e,
                        element: n.dom()
                    })
                }), n = t, o = V(o, function (t, e) {
                    return t !== n
                }), !1 === u() && a()
            },
            inProgress: u,
    ...
    var Vo = ft([{
        ...
        zo = function (n, t) {
            ...
            var e = t.accept();
            n.setRequestHeader("Accept", e), t.credentials().each(function (t) {
                n.withCredentials = t
        ...
        ii = {
            handle: function (n, t, r) {
                ...
                return t.match({
                    ...
                    blob: function () {
                        return t = r, P.from(t.response).map(Ko).getOr(zt.pure("no response content"));
                        var t
                    },
                    text: e,
                    html: e,
        ...
        mi = function (t, e) {
            ...
            return t.match({
                ...
                text: o,
                html: o,
                xml: (n = "Invalid XML document", r = o, function () {
        ...
        Ii = function (t) {
            var e = "";
            return "" !== t.protocol && (e += t.protocol, e += ":"), "" !== t.authority && (e += "//", e += t.authority), e += t.path, "" !== t.query && (e += "?", e += t.query), "" !== t.anchor && (e += "#", e += t.anchor), e
        },
        Si = {
            strictMode: !1,
        ...
        Li = function (t, e) {
            return function (t, e) {
                for (var r = e, n = r.parser[r.strictMode ? "strict" : "loose"].exec(t), o = {}, i = 14; i--;) o[r.key[i]] = n[i] || "";
                return o[r.q.name] = {}, o[r.key[12]].replace(r.q.parser, function (t, e, n) {
                    e && (o[r.q.name][e] = n)
                }), o
            }(t, pt(Si, e))
        },
        ...
        Di = function (t, e) {
            var n = {
                ...
                o = Li(e, n),
                i = {};
            return "" !== o.protocol ? (i.protocol = o.protocol, i.authority = o.authority, i.path = Ci(o.path), i.query = o.query) : ("" !== o.authority ? (i.authority = o.authority, i.path = Ci(o.path), i.query = o.query) : ("" === o.path ? (i.path = r.path, "" !== o.query ? i.query = o.query : i.query = r.query) : (Ie(o.path, "/") ? i.path = Ci(o.path) : (i.path = Oi(r.path, o.path, t.authority), i.path = Ci(i.path)), i.query = o.query), i.authority = r.authority), i.protocol = r.protocol), i.anchor = o.anchor, i
        },
        Ai = function (t, e) {
            var n = Di(t, e);
            return Ii(n)
    ...
    function Pi(d) {
        var t, e, n, r, m = (t = d.url, e = t.lastIndexOf("/"), n = 0 < e ? t.substr(0, e) : t, r = void 0 === d.basePath ? n : d.basePath, Se(r, "/") ? r : r + "/"),
            o = function (t, e, f) {
                var n, r, o, i, a, u, l = wi.getFilename(t, e),
                    c = !0 === d.credentials ? yi.xhr() : yi.none(),
                    s = vi.file(wi.buildData("image", t, l));
                (n = d.url, r = s, o = xi.text(), i = c, u = Xo.post(), pi(n, u, P.some(r), o, i, a)).map(function (t) {
                    t.fold(function (t) {
                        ...
                        try {
                            var i = ei.parse(e);
                            if (!M(i.location)) return t = "JSON response did not contain a string location", r = 500, o = e, void f(Qo.error(wi.failureObject(t, r, o)));
                            n = i.location
                        } catch (t) {
                            n = e
                        }
                        var a, u, c, s = (a = l, u = n.split(/\s+/), c = 1 === u.length && "" !== u[0] ? u[0] : a, Ai(m, c));
                        f(Qo.value({
                            location: s
                        }))
                    })
    ...
    var ki = function (t) {
        ...
        ji = function (t, e) {
            return o = e, i = Mi(n = t, r = "class").concat([o]), ze(n, r, i.join(" ")), !0;
            var n, r, o, i
        },
        Ui = function (t, e) {
            return o = e, 0 < (i = V(Mi(n = t, r = "class"), function (t) {
                return t !== o
            })).length ? ze(n, r, i.join(" ")) : Qe(n, r), !1;
            var n, r, o, i
        },
        Bi = function (t, e) {
        ...
        Yi = function (t, e) {
            var n;
            Ri(t) ? t.dom().classList.remove(e) : Ui(t, e), 0 === (Ri(n = t) ? n.dom().classList : Fi(n)).length && Qe(n, "class")
        },
        Wi = function (t, e) {
        ...
        qi = function (t) {
            return Ri(t) ? function (t) {
                for (var e = t.dom().classList, n = new Array(e.length), r = 0; r < e.length; r++) n[r] = e.item(r);
                return n
            }(t) : Fi(t)
        },
        $i = function (e) {
        ...
        Gi = function (t, r) {
            var o = function (t) {
                for (var e = 0; e < t.childNodes.length; e++) {
                    if (r(ln.fromDom(t.childNodes[e]))) return P.some(ln.fromDom(t.childNodes[e]));
        ...
        Ji = function (t, e, n) {
            return r = Ki, a = n, wo(o = t, i = e) ? P.some(o) : U(a) && a(o) ? P.none() : r(o, i, a);
            var r, o, i, a
        },
        ...
        ea = function (t, e, n, r, o) {
            ...
            return ze(o, yo.blobId(), a.id()), Qi(o, a)
        },
        na = function (e, n) {
            return e.get(n).fold(function () {
                return Qo.error("Internal error with blob cache")
            }, function (t) {
                return e.remove(n), Qo.value(t)
            })
        },
        ra = function (t, e, n) {
            var r = t.isActive(e);
            return t.register(n, e), Bi(n, yo.uploadInProgress()), r ? P.none() : P.some(e)
        },
        oa = function (t, n, a, r, u, e, c) {
            var s = function () {
                l.console.error("Internal error with blob cache", u), c(ta.failure({
                    status: v(666)
                }))
            };
            t.upload(e, u, function (t) {
                var e, i = n.findById(r, u);
                $(i, (e = yo.uploadInProgress(), function (t) {
                    Yi(t, e)
                })), t.fold(function (t) {
                    c(ta.failure(t))
                }, function (e) {
                    var t, n, r, o;
                    (t = a, n = i, r = u, o = e, $(n, function (t) {
                        ze(t, "src", o.location), Qe(t, yo.blobId())
        ...
        aa = function (t, o, e) {
            ...
            return t.inProgress() ? [] : q(n, function (t) {
                return e = o, r = Ze(n = t, yo.blobId()), e.get(r).fold(function () {
                    return Qo.error(r)
                }, function (t) {
        ...
        sa = {
            getTinymceVersion: function () {
                ...
                return t = n.split(".").slice(0, 3).join("."), (e = /([0-9]+)\.([0-9]+)\.([0-9]+)(?:(\-.+)?)/.exec(t)) ? ca(ua(e[1]), ua(e[2]), ua(e[3])) : ca(0, 0, 0)
            }
        };

    function fa(c) {
        var s = function (t, e) {
            return v(4 === (o = sa.getTinymceVersion()).major() && o.minor() < 6 ? t : t + "." + (n = e.toLowerCase(), (r = {
                "image/jpeg": "jpg",
                "image/jpg": "jpg",
                "image/gif": "gif",
                "image/png": "png"
            ...
            importImages: function (t) {
                var e = Q(t, function (t) {
                    return vt.cata(t, function (t, e, n) {
                        var r, o, i, a, u = $t(e);
                        return [(r = t, o = e, i = u, a = n, zt.nu(function (e) {
    ...
    var la = function (t, e) {
            var n = (e || l.document).createElement("div");
            return n.innerHTML = t, Mo(ln.fromDom(n))
        },
        da = function (e, n) {
        ...
        xa = function (t) {
            for (var e = 0; e < t.undoManager.data.length; e++) {
                ...
                $(o, ba), t.undoManager.data[e].content = r.dom().innerHTML
            }
        },
        Ta = function (t, e, n) {
            for (var r = 0; r < t.undoManager.data.length; r++) t.undoManager.data[r].content = t.undoManager.data[r].content.split(e.objurl()).join(n.location)
        },
        Ea = {
        ...
        wa = function (r, t) {
            var o, e, i, a, u, n, c = uo(),
                s = $o(),
                f = (o = r, e = t.url, i = Ea, a = function () {
            ...
            var p = function (o, i) {
                ra(s, o.blobInfo().id(), o.image()).each(function (t) {
                    var e, n, r;
                    e = t, n = o.blobInfo(), r = i, oa(l, s, c, d(), e, n, function (t) {
                        t.fold(function (t) {
                            r(t)
                        }, m)
                    })
            ...
            return {
                ...
                uploadImages: function (t) {
                    var e, n, r, o, i;
                    e = f.instance(), n = aa(s, c, d()), $(n, function (t) {
                        t.fold(function (t) {
                            s.report(t, P.none(), !1)
                        }, function (t) {
                            p(t, e)
                        })
                    }), r = t, o = f.instance(), i = ia(c, d(), r), $(i, function (t) {
                        t.fold(function (t) {
                            console.error(t)
                        }, function (t) {
                            p(t, o)
    ...
    var La = function (e, r, t, n) {
            var o, i, a, u, c, s = e.selection,
                f = e.dom,
                l = e.getBody();
            if (c = t.isText(), t.reset(), n.clipboardData && n.clipboardData.getData("text/html")) {
                n.preventDefault();
            ...
            if (!f.get("_mcePaste")) {
                if (o = f.add(l, "div", {
                        id: "_mcePaste",
                        class: "mcePaste"
                    }, '\ufeff<br _mce_bogus="1">'), u = l !== e.getDoc().body ? f.getPos(e.selection.getStart(), l).y : l.scrollTop, f.setStyles(o, {
                        position: "absolute",
                        left: -1e4,
                        top: u,
                        width: 1,
                        height: 1,
                        overflow: "hidden"
                    }), tinymce.isIE) return (a = f.doc.body.createTextRange()).moveToElementText(o), a.execCommand("Paste"), f.remove(o), "\ufeff" === o.innerHTML ? (e.execCommand("mcePasteWord"), void n.preventDefault()) : (r(c ? o.innerText : o.innerHTML), tinymce.dom.Event.cancel(n));
                var g = function (t) {
                    t.preventDefault()
                };
                if (f.bind(e.getDoc(), "mousedown", g), f.bind(e.getDoc(), "keydown", g), tinymce.isGecko && (a = e.selection.getRng(!0)).startContainer === a.endContainer && 3 === a.startContainer.nodeType) {
                    var v = f.select("p,h1,h2,h3,h4,h5,h6,pre", o);
                    1 === v.length && f.remove(v.reverse(), !0)
                }
                i = e.selection.getRng(), o = o.firstChild, (a = e.getDoc().createRange()).setStart(o, 0), a.setEnd(o, 1), s.setRng(a), window.setTimeout(function () {
                    var n = "",
                        t = f.select("div.mcePaste");
                    gn.each(t, function (t) {
                        var e = t.firstChild;
                        e && "DIV" === e.nodeName && e.style.marginTop && e.style.backgroundColor && f.remove(e, 1), gn.each(f.select("div.mcePaste", t), function (t) {
                            f.remove(t, 1)
                        ...
                        f.remove(t)
                    }), i && s.setRng(i), r(n), f.unbind(e.getDoc(), "mousedown", g), f.unbind(e.getDoc(), "keydown", g)
                }, 0)
            }
        },
        _a = {
    ...
    var Ca, Oa, Da = function (u) {
        ...
        Aa = function (m, p) {
            return function (t) {
                if (m(t)) {
                    var e, n, r, o, i, a, u, c = ln.fromDom(t.target),
                        s = function () {
                            t.stopPropagation()
                        },
                        f = function () {
                        ...
                        l = g(f, s),
                        d = (e = c, n = t.clientX, r = t.clientY, o = s, i = f, a = l, u = t, {
                            target: v(e),
                            x: v(n),
                            y: v(r),
                            stop: o,
        ...
        ja = function (i) {
            return Xt.nu(function (e) {
                var t = function () {
                    ...
                    n = ln.fromTag("script");
                ze(n, "src", i), ze(n, "type", "text/javascript"), ze(n, "async", "async"), ze(n, "data-main", Fa.ephemeral(function (t) {
                    e(Qo.value(t))
                }));
                var r = Ra(n, "error", function () {
                        t(), e(Qo.error("Error loading external script tag " + i))
                    }),
                    o = Ra(n, "load", t);
        ...
        Ua = function (t, e) {
            var n, r, o, i = e || ln.fromDom(l.document),
                a = ln.fromTag("link", i.dom());
            return Ke(a, {
                rel: "stylesheet",
                type: "text/css",
                href: t
            }), n = i, r = a, o = ln.fromDom(n.dom().head), ga(o, r), a
        },
        Ba = function (o, i) {
            return Xt.nu(function (e) {
                var n = function (t) {
        ...
        Ha = Pe.detect(),
        qa = Ha.deviceType.isiOS() || Ha.deviceType.isAndroid(),
        $a = v({
            isSupported: v(!1),
    ...
    var Ga, za, Ka = function (t) {
            t.dom().textContent = "", $(Mo(t), function (t) {
                Za(t)
            })
        },
        Za = function (t) {
        ...
        nu = Pe.detect(),
        ru = nu.browser.isIE() && nu.browser.version.major <= 10,
        ou = ru ? function (t, e, n) {
            e.control.block(), t.dom().execCommand("paste"), n(), e.control.unblock()
        } : function (t, e, n) {
            setTimeout(n, 1)
        },
        iu = {
        ...
        cu = function (t, o) {
            ...
            $(e, function (t) {
                var e, n, r;
                o(t) && (n = Mo(e = t), r = ln.fromTag("div", Co(e).dom()), ya(r, n), da(e, r), Za(e))
            })
        },
        su = {
        ...
        mu = function (t, e, n) {
            if (!M(n)) throw l.console.error("Invalid call to CSS.set. Property ", e, ":: Value ", n, ":: Element ", t), new Error("CSS value must be a string: " + n);
        ...
        Tu = function (t, e) {
            var n = t.dom();
            pu(n, e), Je(t, "style") && "" === Le(Ze(t, "style")) && Qe(t, "style")
        },
        Eu = function (t) {
        ...
        Su = lu.bin(),
        Lu = Su + te(""),
        _u = (Ga = "-100000px", za = "100000px", function (t) {
    ...
    function Nu(e, t, n) {
        var r = function (e, t) {
                ...
                return {
                    ...
                    contents: function () {
                        return su.consolidate(n, r), no("elements", "html", "container")(Mo(n), wu(n), n)
                    },
                    container: function () {
                        return n
                    },
            ...
            i = eu.tap(function () {
                a.trigger.before(), r.attach(t), r.focus(), iu.run(Co(t), i, o)
            }),
            a = so.create({
                before: co([]),
    ...
    var Cu = function (t, e, n, r) {
        ...
        Mu = function (t, e, n) {
            ...
            return r = i, e.fold(function (t) {
                r.setStartBefore(t.dom())
            }, function (t, e) {
                r.setStart(t.dom(), e)
            }, function (t) {
                r.setStartAfter(t.dom())
            }), o = i, n.fold(function (t) {
    ...
    function Yu(n, r) {
        ...
        return {
            get: function (t) {
                if (!n(t)) throw new Error("Can only get " + r + " value of a " + r + " node");
                return o(t).getOr("")
            },
            getOption: o,
            set: function (t, e) {
                if (!n(t)) throw new Error("Can only set raw " + r + " value of a " + r + " node");
                t.dom().nodeValue = e
            }
        }
    }
    var Wu = Yu(Xe, "text"),
            ...
            Uu(f = t, s).match({
                ...
                rtl: function (e, n, r, o) {
                    ...
                    if (s.setBaseAndExtent) s.setBaseAndExtent(e.dom(), n, r.dom(), o);
                        ...
                        i = e, a = n, u = r, c = o, (t = s).collapse(i.dom(), a), t.extend(u.dom(), c)
                    } catch (t) {
                        Vu(f, r, o, e, n)
                    } else Vu(f, r, o, e, n)
                }
        ...
        Gu = function (t) {
            var e, n, r, o, i, a, u = ln.fromDom(t.anchorNode),
                c = ln.fromDom(t.focusNode);
            return e = u, n = t.anchorOffset, r = c, o = t.focusOffset, i = Cu(e, n, r, o), a = _o(e, r) && n === o, i.collapsed && !a ? P.some(Pu(u, t.anchorOffset, c, t.focusOffset)) : function (t) {
                if (0 < t.rangeCount) {
    ...
    function Ju(a) {
        return function (e) {
            var u, r, o, c, n = so.create({
                ...
                i = (u = Zu, r = ln.fromTag("br"), o = P.none(), c = function (t) {
                    ...
                    toOff: function (t, e) {
                        var n = c(e);
                        ga(e, r), o = u.get(n, Xa), u.set(n, Xa(r, 0, r, 0))
                    }
                }),
                t = Nu(i, e, a);
    ...
    var Qu = ft([{
        ...
        pc = function (t) {
            return e = t, n = !1, ln.fromDom(e.dom().cloneNode(n));
            var e, n
        },
        gc = function (t) {
            return $e(t) ? (e = "v:shape", n = He(t), r = ln.fromTag("div"), o = n.indexOf("]>"), r.dom().innerHTML = n.substr(o + "]>".length), Gi(r, function (t) {
                return Ye(t) === e
            })) : P.none();
            var e, n, r, o
        },
                ...
                if ("img" === Ye(t)) {
                    ...
                    if (null != e && Ie(e, "file://")) {
                        var n = pc(t),
                            r = e.split(/[\/\\]/),
                            o = r[r.length - 1];
                        return ze(n, "data-image-id", o), Qe(n, "src"), ze(n, "data-image-type", "local"), Bi(n, "rtf-data-image"), P.some(n)
                    }
                    return P.none()
                }
                return P.none()
            ...
            vshape: function (t) {
                return gc(t).map(function (t) {
                    var e = Ze(t, "o:spid"),
                        ...
                        r = ln.fromTag("img");
                    return Bi(r, "rtf-data-image"), ze(r, "data-image-id", n.substr("_x0000_".length)), ze(r, "data-image-type", "code"), vu(r, {
                        width: hu(t, "width"),
                        height: hu(t, "height")
                    }), r
                })
        ...
        Lc = function (t, e, n) {
            ...
            st(e) !== i.length && (r = t, o = e, $(i, function (t) {
                Qe(r, t)
            }), it(o, function (t, e) {
                ze(r, e, t)
            }))
        ...
        Nc = function (r, o) {
            ...
            return $(null == t ? [] : t, function (t) {
                var e, n = (e = t, r.dom().style.getPropertyValue(e));
                o(n, t) || (i[t] = n)
            }), i
        },
        Cc = function (n, t, e) {
            ...
            var r = st(t),
                o = st(e);
            if (0 === r && 0 === o) Qe(n, "style");
            else if (0 === r) ze(n, "style", _c(e));
            else {
                it(t, function (t, e) {
                    gu(n, e, t)
                });
        ...
        Oc = function (t, e, n) {
            var r, o, i, a = t.dom().getAttribute("style"),
                u = (o = {}, i = null != (r = a) ? r.split(";") : [], $(i, function (t) {
                    var e = t.split(":");
        ...
        jc = function (t, e) {
            var r = pt({
                ...
                n = Yo(t, "*");
            $(n, function (n) {
                Fc(kc, r.styles, n), Fc(Mc, r.attributes, n), $(r.classes, function (e) {
        ...
        qc = function (t, e, n) {
            ...
            switch (t.nodeType) {
            case 1:
                e ? r = Wc : (r = Yc, vu(a, n || {})), o = "HTML" !== t.scopeName && t.scopeName && t.tagName && t.tagName.indexOf(":") <= 0 ? (t.scopeName + ":" + t.tagName).toUpperCase() : t.tagName;
                break;
            case 3:
        ...
        zc = function (t, o) {
            var i;
            o = o || l.window.document, i = o.createElement("div"), o.body.appendChild(i), i.style.position = "absolute", i.style.left = "-10000px", i.innerHTML = t;
            ...
            return {
                ...
                next: function () {
                    var t, e, n = a,
                        r = c;
                    return !c && a.firstChild ? (u.push(a), a = a.firstChild) : c || 1 !== a.nodeType ? a.nextSibling ? (a = a.nextSibling, c = !1) : (a = u.pop(), c = !0) : c = !0, n === Xc.FINISHED || a || (o.body.removeChild(i), a = Xc.FINISHED), e = r, (t = n) === Xc.FINISHED ? t : t ? Xc.token(t, e) : void 0
                }
            }
        },
        Kc = function (t, e, n) {
        ...
        rs = function (t, e, n) {
            ...
            return r.dom().innerHTML = e, $(n, function (t) {
                t(r)
            }), wu(r)
        };
    ...
    function os(a, u, t) {
        return function (e, t, n) {
            var r = function (t) {
                ...
                o = function (t, e, n) {
                    return n = void 0 !== n ? n : t.type() === Xc.END_ELEMENT_TYPE, Xc.token(e, n, {})
                },
                i = {
                    emit: r,
    ...
    var is = function (t, e) {
        ...
        fs = function (t, e) {
            if (void 0 === t || void 0 === e) throw l.console.trace(), "brick";
            t.nextFilter.set(e)
        },
        ls = function (t, e, n) {
        ...
        hs = function (d) {
            return function (t, e, n) {
                var r, o, i, a, u = (r = ln.fromDom(n.getNode()), o = parseInt(Ze(r, "data-list-level"), 10), i = Ze(r, "data-list-emblems"), a = JSON.parse(i), Qe(r, "data-list-level"), Qe(r, "data-list-emblems"), {
                    level: v(o),
                    emblems: v(a)
                });
                u.level(), e.originalToken.set(n);
                var c, s, f, l = (c = n, s = u, gs((f = e).listType.get(), c, f.emitter, s).each(f.listType.set), ps(s.level(), f.originalToken.get(), f.listType.get()));
                e.emitter.openItem(l.level(), l.token(), l.type()), ds(e, d.inside())
            }
        };
    ...
    var Ts, Es, ws, Is, Ss, Ls, _s, Ns, Cs, Os, Ds, As = function (r) {
        ...
        Ps = function (r) {
            return xs("Outside.List.Item", [ys(vs, hs(r), "Data List ****"), ys(function (t, e) {
                ...
                e.emitter.closeAllLists(), t.emit(n), ds(e, r.outside())
            })
        },
        ks = no("state", "result"),
        Ms = no("state", "value"),
        ...
        Vs = function (t, e, n) {
            var r, o, i, a = Ws(e),
                u = t.type() && !ss.eqListType(t.type(), n) ? (r = n, o = qs(t), i = Hs(o.state(), r, r.type ? {
                    "list-style-type": r.type
                } : {}), Rs.result(i.state(), o.result().concat(i.result()))) : Rs.result(t, []),
                c = [y(Xc.createStartElement, "LI", {}, a)],
                s = Fs(u.state(), e && e.tag()),
                f = s.value().map(function (t) {
                    return Rc(e.getNode(), v(!0)), [v(e)]
                }).getOr([]);
        ...
        zs = function (t) {
            if (0 === t.length) throw "Compose must have at least one element in the list";
            var e = t[t.length - 1],
                n = Q(t, function (t) {
                    return t.result()
                });
        ...
        Zs = function (t, c, s, f) {
            return Bs(t, s, function (t) {
                return n = c, r = s, o = f, i = (e = t).level() === r - 1 && n.type ? {
                    "list-style-type": n.type
                } : {}, a = $s(e, n, i), u = Vs(a.state(), a.state().level() == r ? o : void 0, n), zs([a, u]);
                var e, n, r, o, i, a, u
            })
        },
        Js = function (t, e) {
        ...
        Qs = {
            openItem: function (t, e, n, r) {
                var o, i, a, u, c, s, f, l, d, m, p, g, v = t.level() > e ? Js(t, e) : Rs.result(t, []),
                    h = v.state().level() === e ? (l = v.state(), d = r, m = n, p = 0 < l.level() ? Gs(l) : Rs.result(l, []), g = Vs(p.state(), m, d), zs([p, g])) : (o = v.state(), i = r, u = n, c = 1 < (a = e) ? js(o) : Rs.value(o, P.none()), s = c.value().map(function (t) {
                        return [y(Xc.createEndElement, t)]
                    }).getOr([]), c.state().level(), f = Zs(c.state(), i, a, u), Rs.result(f.state(), s.concat(f.result())));
                return zs([v, h])
            },
            closeAllLists: Js
        },
        tf = ["disc", "circle", "square"],
        ef = function (t, e) {
        ...
        uf = (Ts = !1, {
            check: function (t) {
                return Ts && t.type() === Xc.TEXT_TYPE ? (t.text(), !0) : t.type() === Xc.START_ELEMENT_TYPE && "STYLE" === t.tag() ? Ts = !0 : t.type() === Xc.END_ELEMENT_TYPE && "STYLE" === t.tag() && !(Ts = !1)
            }
        }),
        cf = As(af),
        sf = Ps(af),
        ff = (ws = nf(Es = sf), Is = nf(null), Ss = nf(null), {
            reset: function (t) {
                ws.set(Es), Is.set(null), Ss.set(null);
                var n, r, i, a, e = (r = (n = t).document, i = Rs.state(0, void 0, [], []), a = function (t) {
                    $(t.result(), function (t) {
                        var e = t(r);
                        n.emit(e)
                    })
        ...
        gf = function (u, t) {
            var e = pf[u] ? [pf[u]] : [],
                ...
                r = Q(df, function (t) {
                    return t.regex.test(u) ? [pt(t.type, (r = u, o = r.split("."), i = function () {
                        ...
                        variant: (e = t.type, n = u, void 0 !== e.variant ? e.variant : "(" === n.charAt(0) ? "()" : ")" === n.charAt(n.length - 1) ? ")" : ".")
                    })] : [];
                    var e, n, r, o, i, a
                }),
        ...
        xf = function (t) {
            for (var e = []; null !== t.nextNode();) e.push(ln.fromDom(t.currentNode));
            return e
        },
        Tf = Pe.detect().browser,
        Ef = Tf.isIE() || Tf.isEdge() ? function (t) {
            try {
                return xf(t)
            } catch (t) {
                return []
        ...
        Sf = function (t, e, n, r) {
            ...
            }(t, e, n), o = If(t, P.none()), $(o, Za), $(r, Za), Qe(t, "style"), Qe(t, "class")
        },
        Lf = function (t) {
            return (r = t, bf.extractLevel(r).bind(function (n) {
        ...
        Of = {
            ...
            hasContent: function (t) {
                return !Cf(t) || (n = (e = t).dom().attributes, r = null != n && 0 < n.length, ("span" !== Ye(e) || r) && Nf(t, function (t) {
                    var e = !Cf(t),
            ...
            properlyNest: function (n) {
                Oo(n).each(function (t) {
                    ...
                    W(["ol", "ul"], e) && Af(n).fold(function () {
                        var t = ln.fromTag("li");
                        gu(t, "list-style-type", "none"), va(n, t)
                    }, function (t) {
                        ga(t, n)
                    })
                })
        ...
        nl = ts({
            tags: [{
                ...
                mutate: function (t) {
                    ...
                    Bi(e, "ephox-limbo-transform"), gu(e, "text-decoration", "underline")
                }
            }, {
        ...
        il = {
            ...
            inlineTagFixes: nl,
            cleanupFlags: rl,
            distillAnchorsFromLocalLinks: (Os = /^file:\/\/\/[^#]+(#[^#]+)$/, ts({
                tags: [{
                    name: Ec.exact("a", Ec.caseInsensitive),
                    condition: function (t) {
                        var e = Ze(t, "href");
            ...
            removeFragmentComments: function (a) {
                ...
                e.each(function (i) {
                    n.each(function (t) {
                        for (var e, n = i, r = [], o = (e = Cu(i, 0, t, 0), ln.fromDom(e.commonAncestorContainer)); void 0 !== o && !_o(o, a);) W(u, Ye(o)) ? n = o : r.push(o), o = Oo(o).getOr(void 0);
                        $(r, Ja), $(ko(n), Za)
                    }), Za(i)
                }), n.each(Za)
            },
        ...
        ul = function (i, a) {
            return os(function (t, e) {
                var r, o, n = (r = e, o = a, i(ln.fromDom(r.getNode())).fold(function () {
                    return [r]
                }, function (t) {
                    var e = r.type() === Xc.END_ELEMENT_TYPE,
                        n = [Xc.token(t.dom(), e)];
                    return !e && o && n.push(Xc.token(t.dom(), !0)), n
                }));
                $(n, t.emit)
            }, L)
        },
        cl = function (t, e, n) {
            var r, o, i, a, u, c, s, f, l, d, m, p, g, v = (r = t, i = (o = n).browser.isFirefox() || o.browser.isEdge(), a = i ? hc.local : hc.vshape, u = !i, c = al(o) ? il.none : es([ul(a, u)]), {
                annotate: [r ? c : il.none],
                local: [i ? il.none : il.removeLocalImages]
            });
            return J([v.local, (p = t, g = n, al(g) || !p ? [] : [_f.preprocess]), v.annotate, [il.inlineTagFixes], function (t, e, n) {
                    if (!t) return [il.none];
                    var r = [il.unwrapWordTags],
                        o = al(n) ? [] : il.parseLists;
                    return r.concat(o).concat([il.removeWordAttributes])
                }(t, 0, n), [il.removeGoogleDocsId],
                [il.nestedListFixes],
                [il.removeExcess],
                [il.removeMetaTags], (m = e, m ? [il.mergeStyles, il.mergeClasses] : [il.cleanStyles, il.cleanInlineStyleElements, il.cleanClasses]), [il.distillAnchorsFromLocalLinks, il.removeLocalLinks, il.removeVacantLinks, il.replaceClipboardChangedUrls],
                [il.removeEmptyStyle],
                [il.removeEmptyClass],
                [il.pruneInlineTags],
                [il.cleanupBrowserTags], (l = t, d = e, !l && d ? [il.cleanupBrowserCruft] : []), [il.unwrapConvertedSpace],
                [il.addPlaceholders], (s = t, f = n, al(f) && s ? [il.unwrapSingleParagraphsInlists] : []), [il.cleanupFlags],
                [il.removeStyleTags]
            ])
        },
        sl = ["body", "p", "div", "article", "aside", "figcaption", "figure", "footer", "header", "nav", "section", "ol", "ul", "li", "table", "thead", "tbody", "tfoot", "caption", "tr", "td", "th", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "pre", "address"],
        fl = function (t) {
            return e = t, n = v(0), r = v(0), o = P.none(), {
                term: function () {
        ...
        dl = function (t, e, n) {
            var r, o, i = n(t, e);
            return r = i, o = t.start(), q(r, function (t) {
                return ai({}, t, {
                    start: v(t.start() + o),
                    finish: v(t.finish() + o)
                })
        ...
        ml = function (t, n, e) {
            return void 0 === e && (e = 0), X(t, function (e, t) {
        ...
        gl = function (o, t, i) {
            ...
            return e.bind(function (t) {
                var e, n, r = a.getOr((n = i, (e = o)[e.length - 1] && e[e.length - 1].finish() === n ? e.length + 1 : -1));
        ...
        vl = function (n, t) {
            ...
            return e = o, (r = Array.prototype.slice.call(e, 0)).sort(function (t, e) {
                return t.start() < e.start() ? -1 : e.start() < t.start() ? 1 : 0
            }), r
        },
        hl = (no("word", "pattern"), no("element", "offset"), no("element", "deltaOffset"), no("element", "start", "finish")),
        yl = (no("begin", "end"), no("element", "text"), ft([{
            include: ["item"]
        }, {
            excludeWith: ["item"]
        }, {
        ...
        Nl = function (e, t, n) {
            if (e.property().isText(t)) return [_l.text(t, e)];
            if (e.property().isEmptyTag(t)) return [_l.empty(t, e)];
            ...
            var n = Q(e, function (t) {
                ...
                i = pl(t, n, function (t, e) {
                    return function (o, t, e) {
                        ...
                        if (r.length <= 1) return [hl(t, 0, n.length)];
                        ...
                        return o.insert().afterAll(t, a), [hl(t, 0, r[0].length)].concat(i)
                    }(o, t.element(), e)
                });
            return q(e, function (t) {
        ...
        Pl = function (a, t, u, e) {
            ...
            return Q(n, function (t) {
                var r, e = Q(t, function (t) {
                    ...
                    n = q(e, a.property().getText).join(""),
                    o = vl(n, u),
                    i = (r = a, ml(e, function (t, e) {
        ...
        Bl = {
            links: function (t) {
                ...
                $(e, function (t) {
                    var n, e = t.exact();
                    (e.indexOf("@") < 0 || Ul(e)) && (n = t.elements(), P.from(n[0]).filter(jl).map(function (t) {
                        var e = ln.fromTag("a");
                        return da(t, e), ya(e, n), ze(e, "href", vf(e)), e
                    }))
                })
            },
            position: function (t) {
        ...
        Vl = function (t) {
            ...
            return it(t, function (r, o) {
                e[o] = function (t) {
                    return {
                        _simpleAdt: i(o),
                        data: (e = r, n = t, 0 === e.length ? {} : io(e, [])(n)),
                        _simpleAdt_data: t
                    };
                    var e, n
                }
        ...
        Ql = Pe.detect().browser,
        td = !(Ql.isIE() || Ql.isEdge() && Ql.version.major < 16),
        ed = ["^image/", "file"],
        nd = function (t) {
        ...
        sd = function (t) {
            ...
            var n = $l(Co(e), e),
                r = ln.fromTag("div");
            return Iu(r, n), Jl.constructors.html({
                container: r
            })
        },
        fd = function (t) {
            ...
            return {
                getWordData: function () {
                    return cd(t).bind(function (n) {
                        return (t = n, ad(t).filter(nd)).map(function (t) {
                            var e = id(n, "rtf");
                ...
                getOnlyText: function () {
                    return cd(t).bind(function (t) {
                        return e = t.types, n = "text/plain", 1 === e.length && e[0] === n ? r(t) : P.none();
                        var e, n
                    })
                },
                getNative: function () {
            ...
            r = function (t, e, n) {
                ...
                mc(o, r.input()).get(function (t) {
                    ...
                    ec.cata(t.response(), function (t) {
                        ...
                        u.trigger.insert(t, md(e), e, r), u.trigger.error(n)
                    })
                })
            },
            o = eu.tap(function (n) {
                zu(n.target.ownerDocument.defaultView).each(function (t) {
                    if (!Wi(t.start(), lu.bin())) {
                        var e = fd(n);
                        iu.willBlock() && (o.control.block(), n.preventDefault()), r(e, o.control, function () {
                            n.preventDefault()
                        })
                    }
                })
    ...
    var gd = function () {
            ...
            return {
                convert: function (t) {
                    e = function (n) {
                        var t, e = yt("window.clipboardData.files"),
                            r = void 0 !== (t = n).convertURL ? t.convertURL : void 0 !== t.msConvertURL ? t.msConvertURL : void 0;
                        if (void 0 !== e && void 0 !== r && 0 < e.length) {
                            var o = Jt(e, function (t) {
                                var e = Me(t);
                                return r.apply(n, [t, "specified", e]), sn.singleWithUrl(t, e)
                            });
                            return P.some(o)
                        }
                        return P.none()
        ...
        xd = function (e, t) {
            return (n = t, Ot(n)).map(function (t) {
        ...
        Sd = function (t) {
            return Q(Td(t), function (t) {
                var n, e, r = Ze(t, "src");
                return Ed(r) ? xd(t, r).toArray() : wd(r) ? (n = t, e = r, Mt(e).map(function (t) {
            ...
            return fc(function (a) {
                var u = function () {
                    ...
                    c = function (t) {
                        var e, n, r = V(Td(t), Id);
                        $(r, Za), uc(a, {
                            response: 0 < r.length ? (e = t, n = V(e, function (t) {
                    ...
                    t = function (t, e) {
                        var n, r, o, i;
                        !1 === f.allowLocalImages ? c(t) : 0 === e.length ? (r = Sd(n = t), o = Jt(r, function (t) {
                            return t.asset()
                        }), i = q(r, function (t) {
                            return t.image()
                        }), o.get(function (t) {
    ...
    var Pd, kd, Md, Rd = function (t, e) {
        ...
        Ud = function (t) {
            return function (t) {
                ...
                try {
                    ...
                    return l.console.log("Error reading iframe: ", e), l.console.log("Error was: " + t), P.none()
                }
            }(t).fold(function () {
                return t
            }, function (t) {
        ...
        Bd = function (t, e) {
            if (!bo(t)) throw "Internal error: attempted to write to an iframe that is not in the DOM";
            var n = Ud(t).dom();
            ...
            return function i(a, u, c) {
                ...
                1: [function (t, e, n) {
                    var r, a, o = (r = function (t) {
                        var e, n, r, o, i = [];
                        for (r = 0, o = (e = t.split(",")).length; r < o; r += 1) 0 < (n = e[r]).length && i.push(a(n));
                        return i
                    }, a = function (c) {
                        var t, e, n, s = c,
                            f = {
                        ...
                        return t = function (t, e) {
                                var n, r, o, i, a, u;
                                if (t.test(s))
                                    for (r = 0, o = (n = s.match(t)).length; r < o; r += 1) f[e] += 1, i = n[r], a = s.indexOf(i), u = i.length, l.push({
                                ...
                                var e, n, r, o;
                                if (t.test(s))
                                    for (n = 0, r = (e = s.match(t)).length; n < r; n += 1) o = e[n], s = s.replace(o, Array(o.length + 1).join("A"))
                            })(/\\[0-9A-Fa-f]{6}\s?/g), e(/\\[0-9A-Fa-f]{1,5}\s/g), e(/\\./g), (n = /:not\(([^\)]*)\)/g).test(s) && (s = s.replace(n, "     $1 ")),
                            function () {
                                var t, e, n, r, o = /{[^]*/gm;
                                if (o.test(s))
                                    for (e = 0, n = (t = s.match(o)).length; e < n; e += 1) r = t[e], s = s.replace(r, Array(r.length + 1).join(" "))
                            }(), t(/(\[[^\]]+\])/g, "b"), t(/(#[^\#\s\+>~\.\[:]+)/g, "a"), t(/(\.[^\s\+>~\.\[:]+)/g, "b"), t(/(::[^\s\+>~\.\[:]+|:first-line|:first-letter|:before|:after)/gi, "c"), t(/(:[\w-]+\([^\)]*\))/gi, "b"), t(/(:[^\s\+>~\.\[:]+)/g, "b"), s = (s = s.replace(/[\*\s\+>~]/g, " ")).replace(/[#\.]/g, " "), t(/([^\s\+>~\.\[:]+)/g, "c"), l.sort(function (t, e) {
    ...
    var Xd = Vd.exports.boltExport,
        ...
        zd = function (e, t) {
            var n = Q(t, function (i) {
                ...
                return $(t, function (t) {
                    var n, r, o, e = (n = i.raw(), r = t, o = {}, $(n, function (t) {
                        if (void 0 !== n[t]) {
                            var e = r.dom().style;
                            W(e, t) || (o[t] = n[t])
                        }
        ...
        nm = function (l, t) {
            ...
            if ($(e, function (t) {
                ...
                var n = Yo(l, "li");
                $(n, function (t) {
                    var e, n, r, o, i, a, u, c = (e = l, n = ln.fromTag("span"), pa(e, n), r = n, {
                            convertToPx: function (t) {
                                var e;
                                return gu(r, "margin-left", t), e = hu(r, "margin-left"), parseFloat(e.match(/-?\d+\.?\d*/)[0])
                            },
                            destroy: function () {
                                return Za(r)
                            }
                        }),
                        s = (i = c, a = Je(o = l, "data-tab-interval") ? Ze(o, "data-tab-interval") : "36pt", i.convertToPx(a)),
                        f = rm(t, s, c).getOr({});
                    Qe(u = t, "data-list-level"), Qe(u, "data-text-indent-alt"), Qe(u, "data-border-margin"), Tu(u, "margin-left"), Tu(u, "text-indent"), it(xu(u), function (t, e) {
        ...
        om = function (t, e, n) {
            var r = n.mergeInline();
            (r ? Qd.inlineStyles : em)(t, e, tm), nm(e, r)
        },
        im = function (n) {
            var t, r = (t = ln.fromDom(l.document.body), {
                play: function (i, a, u) {
                    ...
                    var f = Ra(s, "load", function () {
                        ...
                        if (void 0 === t) throw "sandbox iframe load event did not fire correctly";
                        var e = ln.fromDom(t),
                            n = t.body;
                        if (void 0 === n) throw "sandbox iframe does not have a body";
                        var r = ln.fromDom(n),
                            o = a(e, r);
                        Za(c), l.setTimeout(y(u, o), 0)
                    });
                    ga(c, s), ga(t, c)
                }
            });
        ...
        um = function (t) {
            ...
            return fc(function (n) {
                sn.multiple(r).get(function (t) {
                    var a, u, e = (a = [], u = [], $(t, function (i) {
                        return vt.cata(i, function (t, e, n, r) {
                            var o = ln.fromTag("img");
                            ze(o, "src", n), a.push(o), u.push(vd(i, o))
                        }, function (t, e, n) {
        ...
        sm = function (t) {
            try {
                ...
                return l.console.error(t), Qo.error("errors.paste.process.failure")
            }
        },
        fm = function (t) {
            return t.fold(function (t) {
        ...
        pm = function (t, e, n, r, i) {
            return lm(t, e, r, n).fold(function (t) {
                ...
                return fc(function (r) {
                    i.get(function (t) {
                        var e, i, a, n = (e = t, i = [], a = Q(o, function (t) {
        ...
        hm = function (t) {
            ...
            return e = t, n.dom().textContent = e, wu(n)
        },
        ym = function (t) {
            var e = t.trim().split(/\n{2,}|(?:\r\n){2,}/),
                n = q(e, function (t) {
        ...
        bm = function (t) {
            ...
            return fc(function (t) {
                var e, n, r, o, i = 0 < a.text().length ? (e = a.text(), n = hm(e), r = ym(n), o = la(r), ec.paste(o, [])) : ec.cancel();
                uc(t, {
                    response: i,
                    bundle: oc({})
                })
        ...
        Sm = function (a, u) {
            return function (t, e) {
                var n = Jl.asHtml(t).getOrDie("Wrong input type for HTML handler").container(),
                    r = Co(u),
                    o = e.bundle();
                if (Od.isInternal(o)) return mm(r, n);
                a(n);
                var i = Od.merging(o);
                return dm(r, n, i)
            }
    ...
    var Fm = function (t, e) {
            if (0 === t.length) throw "Zero length content passed to Hex conversion";
        ...
        Hm = function (t, e) {
            ...
            var n, r, o = 0,
                i = t.length;
            do {
                if ((n = t.indexOf("{", e)) < (r = t.indexOf("}", e)) && -1 !== n ? (e = n + 1, ++o) : (r < n || n < 0) && -1 !== r && (e = r + 1, --o), i < e || -1 === r) return -1
            } while (0 < o);
            return e
        },
        qm = function (t, e, n, r, o) {
            var i, a, u, c = Wm(t, n, r),
                s = (a = Bm("\\picscalex", i = t, n), u = Bm("\\bliptag", i, a), -1 < a && a < u ? P.from(i.substring(a, u)) : P.none());
        ...
        Zm = function (t) {
            for (var u = [], e = function () {
                    ...
                    var e, r, o, i, a, n = (r = (e = t).bower, o = e.regex, i = e.isEquation, a = e.attrs, Km(r).map(function (t) {
                        var n = e.idRef + t;
                ...
                }, r = 0; r < t.length;) r = Xm(t, r).fold(e, n);
            return u
        },
        Jm = function (t) {
    ...
    function tp(a, u, c, s, f) {
        return a.toCanvas().then(function (t) {
            return e = t, n = a.getType(), r = u, o = c, _t(i = St(s, f)).drawImage(e, -r, -o), jt(i, n);
            var e, n, r, o, i
        })
    }
    var ep, np, rp, op = {},
                    ...
                    (function (t, e) {
                        ...
                        s.setTimeout = function () {
                            ...
                            return i[e] = !0, r(function () {
                                i[e] && (n ? t.apply(null, n) : t.call(null), s.clearImmediate(e))
                            }), e
            ...
            return e.fold(function () {
                ...
                return vt.cata(t, function (s, f, t) {
                    return f.toCanvas().then(function (t) {
                        var e, n, r, o, i, a = parseInt(Ze(ln.fromDom(t), "width"), 10) || 1,
                            u = parseInt(Ze(ln.fromDom(t), "height"), 10) || 1,
                            c = cp(l, a, u);
                        return (e = f, n = c.cropl, r = c.cropt, o = c.cropw, i = c.croph, tp(e, n, r, o, i)).then(function (t) {
            ...
            convert: function (t, e, n, o) {
                var i = X(e, function (e, n) {
                    ...
                    r = Q(t, function (n) {
                        ...
                        return Qe(n, "rtf-data-image"), Qe(n, "data-image-id"), Qe(n, "data-ms-equation"), "unsupported" === e ? (c = !0, ze(n, "alt", o("errors.imageimport.unsupported")), []) : G(i, function (t) {
                            return Qm.toId(t) === e && Qm.isEquation(t) === r
                        }).fold(function () {
                            return l.console.log("WARNING: unable to find data for image ", n.dom()), c = !0, ze(n, "alt", o("errors.imageimport.unsupported")), []
                        }, function (e) {
                            return Qm.toBlob(e).fold(function (t) {
                                return c = !0, ze(n, "alt", o(t)), []
                            }, function (t) {
                                return a.push(n), u.push(Qm.getAttrs(e)), [t]
                            })
                        })
                    });
                sn.multiple(r).get(function (t) {
    ...
    var gp = function (o) {
        ...
        return vt.cata(o.asset(), function (t, e, n) {
            return /tiff$/.test(e.getType()) ? (r = e, zt.nu(function (e) {
                var t = Ht(r, "image/png").then(function (t) {
                    sn.single(t).map(P.some).get(e)
                });
                return t.catch.call(t, function (t) {
                    return l.console.warn(t), e(P.none()), t
                })
            })).map(function (t) {
                return t.map(function (t) {
                    var e = o.image();
                    return Re(n), hd(t, e), vd(t, e)
                }).getOr(o)
            }) : i();
            var r
        }, i)
    ...
    var hp = function (t) {
        ...
        Op = function (t, e, n) {
            return Lp("Word Import pasting", y(yp, t), [hp(Nm({
                isWord: !0
            })), hp(Fd(e, n)), hp(_m(t, n.allowLocalImages)), (r = pp(n), function (n) {
                return function (t, e) {
                    return n.block(), r(t, e).map(function (t) {
                        return n.unblock(), t
                    })
                }
            }), hp(vp())], !0);
        ...
        Wp = function () {},
        Hp = function (t, e, n) {
            if (r = t, !1 !== tinymce.Env.iOS || void 0 === r || "function" != typeof r.setData) return !1;
            try {
                return t.clearData(), t.setData("text/html", e), t.setData("text/plain", n), t.setData(Yp.internalHtmlMime(), e), !0
            } catch (t) {
                return !1
            }
            var r
        ...
        qp = function (t, e, n, r) {
            Hp(t.clipboardData, e.html, e.text) ? (t.preventDefault(), r()) : n(e.html, r)
        },
        $p = function (a) {
            return function (t, e) {
        ...
        ug = {
            process: function (t, e, n) {
                ...
                return d = v, m = n, o = ig(l = r = t, "PastePreProcess") ? (p = d, g = m, l.fire("PastePreProcess", {
                    internal: g,
                    content: p
                }).content) : d, i = n, ig(r, "PastePostProcess") ? (u = o, c = i, s = (a = r).dom.add(a.getBody(), "div", {
                    style: "display:none"
                }, u), f = a.fire("PastePostProcess", {
                    internal: c,
                    node: s
                }).node.innerHTML, a.dom.remove(s), f) : o
            },
    ...
    function cg(g, v, t, e, h, y) {
        var b, x, T, E, w = nf(P.none()),
            n = function (t, e) {
                return t.replace(/\/$/, "") + "/" + e.replace(/^\//, "")
            };
        E = n(e ? e.jsUrl : t, "/js"), x = n(e ? e.swfUrl : t, "/flash/textboxpaste.swf"), T = n(e ? e.imgUrl : t, "/img/spinner_96.gif");
        var I = function (t, e, n) {
                var r, o = !1 !== t.settings.smart_paste ? [og.linkSelection, og.insertImage] : [];
                og.until(t, e, o.concat([(r = n, function (t, e) {
                    return t.undoManager.transact(function () {
                        og.insertContent(t, e), Gp.restoreStyleAttrs(t.getBody()), h.prepareImages(r)
                    }), P.some(!0)
                })]))
            },
            S = function () {
                b && g.selection.moveToBookmark(b), b = null
            };
        g.on("init", function (t) {
            ...
            var s, a, e, n, r, o, i, u, c = {
                ...
                l = ln.fromDom(g.getBody()),
                d = (e = l, n = f.createDialog, r = L, i = Va((o = c).baseUrl), u = Ju(void 0 !== o.pasteBinAttrs ? o.pasteBinAttrs : {}), pd([Pp(), Op(i, n, o), Dp(o, r, e), Np(n, o, r, e), Ap(o)], Cp(n, o, r, u, e))),
                m = pd([kp()], Mp());
            $([d, m], function (t) {
                t.events.cancel.bind(function () {
                    S()
                }), t.events.error.bind(function (t) {
                    S(), g.notificationManager ? g.notificationManager.open({
                    ...
                    g.focus(), h.importImages(t.assets()).get(function () {
                        S(), I(g, ug.process(g, n, t.isInternal()), t.assets()), h.uploadImages(t.assets())
                    })
                })
            ...
            var p = Ra(l, "paste", function (t) {
                b || (b = g.selection.getBookmark(1)), (v.isText() ? m : d).paste(t.raw()), v.reset()
            });
            w.set(P.some(p)), Xp.register(g)
        }), g.on("remove", function (t) {
            1 === tinymce.editors.length && jp.removeStyles(), w.get().each(function (t) {
                return t.unbind()
            })
        })
    }
    ...
    function fg(u) {
        return c(tinymce, "4.0.28") ? (e.error('The "powerpaste" plugin requires at least 4.0.28 version of TinyMCE.'), function () {}) : function (n, t) {
            var e, r = !c(tinymce, "5.0.0"),
                o = function (e, n) {
                    var r = nf(d(e)),
                        o = nf(!1);
                    e.on("keydown", function (t) {
                        sg(t) && (o.set(!0), tinymce.Env.ie && tinymce.Env.ie < 10 && (t.preventDefault(), e.fire("paste", {})))
                    });
                    var i = function () {
                        var t = !r.get();
                        r.set(t), e.fire("PastePlainTextToggle", {
                            state: t
                        }), e.focus()
                    };
                    return {
                ...
                a = function () {
                    var e = this;
                    e.active(o.isText()), n.on("PastePlainTextToggle", function (t) {
                        e.active(t.state)
                    })
                };
            tinymce.Env.ie && tinymce.Env.ie < 10 ? function (e, t, n) {
                var r, o, i = this,
                    a = to(e, mn.translate, !1),
                    u = function (e) {
                        return function (t) {
                            e(t)
                        }
                    };
                r = _a.getOnPasteFunction(e, a.showDialog, t), e.on("paste", u(r)), o = _a.getOnKeyDownFunction(e, a.showDialog, t), e.on("keydown", u(o)), e.addCommand("mceInsertClipboardContent", function (t, e) {
            ...
            }(n, o) : (e = Sa(n), cg(n, o, t, u, e, r), f(n) ? m(n) : eo(n, 0, 0, e, r)), ug.registerEvents(n), r ? (n.ui.registry.addToggleButton("pastetext", {
                icon: "paste-text",
    ...
    return function (t) {
        tinymce.PluginManager.requireLangPack("powerpaste", "ar,ca,cs,da,de,el,es,fa,fi,fr_FR,he_IL,hr,hu_HU,it,ja,kk,ko_KR,nb_NO,nl,pl,pt_BR,pt_PT,ro,ru,sk,sl_SI,sv_SE,th_TH,tr,uk,zh_CN,zh_TW"), tinymce.PluginManager.add("powerpaste", fg(t))
    }
}(window)();
